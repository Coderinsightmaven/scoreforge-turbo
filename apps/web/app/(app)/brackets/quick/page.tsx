            ...
            <div className="bg-bg-card border border-border rounded-2xl p-6 shadow-card">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full px-4 py-3 inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all bg-brand text-white hover:bg-brand-hover shadow-sm mt-4"
                >
                  Generate Bracket
                </button>
              </div>
          ...
          <div className="animate-fadeIn">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6 no-print">
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={handlePrint}
                  className="inline-flex items-center gap-1.5 px-4 py-2 inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all bg-brand text-white hover:bg-brand-hover shadow-sm text-xs"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
